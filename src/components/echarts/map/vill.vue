<template>
  <div>
    ...
    <div class="box">
      ...
      <div id="mapChartaa" class="chart"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  created(){
    this.myChart = echarts.init(document.getElementById("mapChartaa"));
    this.chinaId = this.$route.params.id;
    this.chinaName = this.$route.params.name;
    this.chinaJson = this.$route.params.json;
    console.log("a",this.chinaId,this.chinaName,this.chinaJson);
